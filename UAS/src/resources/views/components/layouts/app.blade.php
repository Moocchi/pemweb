...
<head>
    ...
    <!-- Favicons -->
    <link href="{{ asset('front/img/Google_Drive_logo.png') }}" rel="icon">
    <link href="{{ asset('front/img/Google_Drive_logo.png') }}" rel="apple-touch-icon">
...
<body class="index-page">
    ...
    <header id="header" class="header d-flex align-items-center fixed-top p-0">
        <div class="container position-relative d-flex align-items-center justify-content-between posisi">
            ...
            <div class="logo-perusahaan">
                <h1 style="color: black; font-weight: bold;">My Files</h1>
            </div>
    ...
    <footer id="footer" class="footer light-background">
        ...
        <div class="container copyright text-center mt-4">
            <p>© <span>Copyright</span> <strong class="px-1 sitename">My Files.</strong> <span>All Rights
                    Reserved</span></p>
            <div class="credits">
                Designed by <a href="https://github.com/piowarior">My Files Team</a>
            </div>
        </div>
